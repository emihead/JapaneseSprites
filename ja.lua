return {
    descriptions = {
        Joker = {
            ...
            j_four_fingers = {
                name = "フォーフィンガー",
                text = {
                    "すべての {C:attention}フラッシュ{} と {C:attention}ストレート{} を",
            ...
            j_steel_joker = {
                name = "スチールジョーカー",
                text = {
                    "{C:attention}フルデッキ{}内の",
                    "{C:attention}スチールカード{}1枚につき、",
                    "倍率 {X:mult,C:white}X#1#{} を追加する",
            ...
            j_hack = {
                name = "詐欺師",
                text = {
                    "{C:attention}2{}、{C:attention}3{}、{C:attention}4{}、{C:attention}5{} の {C:attention}カード{} が",
                    "プレイされるごとに",
                    "再発動する"
                }
            },
            ...
            j_business = {
                ...
                text = {
                    ...
                    "{C:green}#2#分の#1#{} の確率で {C:money}$2{} を与える"
                }
            },
            j_supernova = {
                name = "超新星",
            ...
            j_egg = {
                ...
                text = {
                    "ラウンド終了時に",
                    "{C:attention}売値{}を {C:money}$#1#{} 追加する"
                }
            },
            j_burglar = {
                name = "強盗",
            ...
            j_dna = {
                name = "DNA",
                text = {
                    "ラウンドの {C:attention}最初のハンド{} の",
                    "カードが {C:attention}1{} 枚しかない場合",
                    "永久的なコピーを1枚デッキに加えて",
            ...
            j_sixth_sense = {
                name = "シックスセンス",
                text = {
                    "ラウンドの {C:attention}最初のハンド{} で",
                    "{C:attention}6{} のカード1枚を使用した場合",
            ...
            j_faceless = {
                name = "フェイスレスジョーカー",
                text = {
                    "{C:attention}#2#{} 枚以上の {C:attention}フェイスカード{} が",
                    "同時にディスカードされた場合",
                    "{C:money}$#1#{} を得る"
                }
            },
            ...
            j_bloodstone = {
                name = "ブラッドストーン",
                text = {
                    "{C:hearts}ハート{} カードがスコアされると",
                    "{C:green}#2#分の#1#{} の確率で倍率 {X:mult,C:white}X#3#"
                },
                unlock = {
                    "デッキに",
                    "{E:1,C:attention}#1#{} 枚以上の",
            ...
            j_wee = {
                name = "ウィージョーカー",
                text = {
                    "プレイした {C:attention}2{} のカードが",
                    "スコアされるごとに",
                    "これはチップを{C:chips}+#2#{} 得る",
                    "{C:inactive}（現在{C:chips}+#1#{C:inactive} チップ）"
                },
                unlock = {
            ...
            j_seance = {
                name = "降霊術",
                text = {
                    "{C:attention}役{} が {C:attention}#1#{} だった場合",
                    "ランダムな {C:spectral}スペクトル{} カードを1枚作る",
                    "{C:inactive}（空きが必要）"
                }
            },
            j_riff_raff = {
            ...
            j_obelisk = {
                ...
                text = {
                    "最も多くプレイした",
                    "{C:attention}役{}以外を{C:attention}連続{}で",
                    "プレイするたびに",
                    "倍率 {X:mult,C:white}X#1#",
                    "{C:inactive}（現在 倍率 {X:mult,C:white}X#2#{C:inactive}）"
                }
            ...
            j_gift = {
                ...
                text = {
                    ...
                    "{C:attention}消耗{} カードの {C:attention}売値{} に",
                    "{C:money}$#1#{} を加える"
                }
            },
            j_turtle_bean = {
            ...
            j_castle = {
                name = "キャッスル",
                text = {
                    "{V:1}#2#{} カードがディスカードされた時",
                    "これはチップ {C:chips}+#1#{} を得る",
                    "{s:0.8} スーツはラウンドごとに変わる",
        ...
        Tarot = {
            c_fool = {
                ...
                text = {
                    "このランで使用された最後の最後の",
                    "{C:tarot}タロット{} または {C:planet}惑星{} カードを作る",
            ...
            c_wheel_of_fortune = {
                name = "運命の輪",
                text = {
                    "{C:green}#2#分の#1#{} の確率でランダムな {C:attention}ジョーカー{} に",
                    "{C:dark_edition}フォイル{}、 {C:dark_edition}ホログラム{}、 {C:dark_edition}ポリクローム",
                    "エディションのいずれかを加える"
                }
            },
            c_strength = {
        ...
        Spectral = {
            c_familiar = {
                name = "ファミリア",
                text = {
                    "手札のランダムなカード {C:attention}1{} 枚を破壊して",
                    "ランダムな {C:attention}強化されたフェイスカード{} を",
                    "{C:attention}#1#{} 枚手札に加える"
                }
            },
            c_grim = {
                name = "グリム",
            ...
            c_incantation = {
                ...
                text = {
                    "手札のランダムなカード {C:attention}1{} 枚を破壊して",
                    "ランダムな {C:attention}強化されたナンバーカード{} を",
                    "{C:attention}#1#{} 枚手札に加える"
                }
            },
            c_talisman = {
            ...
            c_wraith = {
                name = "レイス",
                text = {
                    "ランダムな {C:red}レア {C:attention}ジョーカー{} を作り",
                    "資金を {C:money}$0{} にする"
                }
            },
            c_sigil = {
            ...
            c_ouija = {
                ...
                text = {
                    "手札のすべてのカードを",
                    "ランダムな1つの {C:attention}ランク{} に変換する",
                    "手札の最大枚数 {C:red}-1{}"
                }
            },
            c_ectoplasm = {
            ...
            c_ankh = {
                name = "アンク",
                text = {
                    "ランダムな {C:attention}ジョーカー{} のコピーを作る",
                    "他のすべてのジョーカーを破壊する"
                }
            },
            c_deja_vu = {
            ...
            c_soul = {
                name = "魂",
                text = {
                    "{C:legendary,E:1}レジェンド{} ジョーカーを作る",
                    "{C:inactive}（空きが必要）"
                }
            },
            c_black_hole = {
                name = "ブラックホール",
                text = {
                    "すべての {C:legendary,E:1}役{} を{C:attention}1{} レベル",
                    "アップグレードする"
                }
            }
        },
        ...
        Back = {
            ...
            b_magic = {
                ...
                text = {
                    ...
                    "{C:tarot,T:c_fool}#2#{} の {C:attention}2{} つのコピーで",
                    "ランをスタートする"
                }
            },
            b_nebula = {
        ...
        Other = {
            ...
            p_arcana_normal = {
                name = "アルカナパック",
                text = {
                    "{C:attention}#2#{} 枚の {C:tarot}タロット{} カードから",
                    "{C:attention}#1#{} 枚まで選んですぐに使用する"
                }
            },
            p_arcana_jumbo = {
                name = "ジャンボアルカナパック",
            ...
            p_celestial_normal = {
                name = "天体パック",
                text = {
                    "{C:attention}#2#{} 枚の {C:planet}惑星{} カードから",
                    "{C:attention}#1#{} 枚まで選んですぐに使用する"
                }
            },
            p_celestial_jumbo = {
            ...
            p_spectral_normal = {
                name = "スペクトルパック",
                text = {
                    "{C:attention}#2#{} 枚の {C:spectral}スペクトル{} カードから",
                    "{C:attention}#1#{} 枚まで選んですぐに使用する"
                }
            },
            p_spectral_jumbo = {
            ...
            p_standard_normal = {
                name = "スタンダードパック",
                text = {
                    "{C:attention}#2#{} 枚の {C:attention}トランプ{} から",
                    "{C:attention}#1#{} 枚まで選んでデッキに加える"
                }
            },
            p_standard_jumbo = {
                name = "ジャンボスタンダードパック",
            ...
            p_buffoon_normal = {
                name = "道化師パック",
                text = {
                    "{C:attention}#2#{} 枚の {C:joker}ジョーカー{} カードから",
                    "{C:attention}#1#{} 枚まで選ぶ"
                }
            },
            p_buffoon_jumbo = {
    ...
    misc = {
        ...
        v_dictionary = {
            ...
            a_chips = "+#1#",
            a_chips_minus = "-#1#",
            a_handsize = "+#1# 手札の最大枚数",
            a_handsize_minus = "手札の最大枚数 -#1#",
            a_hands = "+#1# ハンド",
        ...
        tutorial = {
            ...
            fh_1 = {
                "{C:attention}役{} をプレイして",
                "チップを獲得しよう。"
            },
            fh_2 = {
                "それぞれの {C:attention}役{} は",
                "{C:blue}チップ{} の基本値に",
                "{C:red}倍率{} をかけた額を獲得する。"
            },
            fh_3 = {
                "{C:attention}ラン情報{} エリアで",
                "{C:attention}役{} を確認しよう。",
                "現在のランに関する",
                    "その他の情報もある。"
            },
            fh_4 = {
